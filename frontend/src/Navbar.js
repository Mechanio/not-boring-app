...
export default function MyNavbar() {
    ...
    //             setProfileInfo(response.data)
    //             console.log(profileInfo)
    //             setActivityLists(profileInfo.activity_lists)
    //         })
    // }
    //
    // useEffect(() => {
